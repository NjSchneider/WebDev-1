  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                ...
                <a class="dropdown-item active" href="shotgun.php">Shotgun</a>
    ...
    <div class="container-fluid course-article">
      ...
      <div class="container course-info">
        <h2><?php echo $shotgun_course['shotgun_title'] ?></h2>
        <div class="header-line-equipment"></div>
        <br>
        <h4>Prerequisites:</h4>
        <ul class="learn-list">
          <?php
            $paragraph = $shotgun_course['shotgun_prerequisites'];
            $lines = str_replace(".","<li>", $paragraph);
            echo $lines;
           ?>
        </ul>
        <p>
          <?php echo nl2br($shotgun_course['shotgun_info']); ?>
        </p>
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="learn-list">
              <?php
                $paragraph = $shotgun_course['shotgun_learn'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
          ...
          <div class="col-lg-6">
            ...
            <ul class="equipment-list">
              <?php
                $paragraph = $shotgun_course['shotgun_equipment'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
        ...
        <?php
          $counter = $shotgun_course['shotgun_id'];
          $counter += 1;
         ?>
        <br <?php echo $counter; ?>>

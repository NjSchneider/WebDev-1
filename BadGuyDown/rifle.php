<?php
  ...
  $rifle_course = new Rifle_Course;
  $rifle_courses = $rifle_course->fetch_all();
...
<html>
  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                ...
                <a class="dropdown-item active" href="rifle.php">Rifle</a>
    ...
    <div class="course-banner">
      ...
      <div class="header-line" id="rifle1"></div>
      <br>
      <nav class="navbar navbar-expand-lg course-intraNav" id="rifle-nav">
        <button class="navbar-toggler course-nav-btn" type="button" data-toggle="collapse" data-target="#courseNav" aria-controls="courseNav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"><i class="fas fa-caret-down"></i></span> <strong>Rifle Courses</strong>
        </button>
        <div class="collapse navbar-collapse" id="courseNav">
          <ul class="navbar-nav ml-auto mr-4">
            <?php foreach($rifle_courses as $rifle_course){ ?>
            <li>
              <strong><a href="#rifle<?php echo $rifle_course['rifle_id'] ?>"><?php echo $rifle_course['rifle_tag'] ?></a></strong>
            </li>
          <?php } ?>
          </ul>
        </div>
      </nav>
      <a class="btn btn-secondary chart-button" href="#rifle-chart"><span class="float-left double-down"><i class="fas fa-angle-double-down"></i></span>Rifle Course Progression</a>
    </div>

    <div class="container-fluid course-article">
      <?php foreach($rifle_courses as $rifle_course){ ?>
      <div class="container course-info">
        <h2><?php echo $rifle_course['rifle_title']; ?></h2>
        <div class="header-line-left"></div>
        <br>
        <h4>Prerequisites:</h4>
        <ul class="learn-list">
          <?php
            $paragraph = $rifle_course['rifle_prerequisites'];
            $lines = str_replace(".","<li>", $paragraph);
            echo $lines;
           ?>
        </ul>
        <p>
          <?php echo nl2br($rifle_course['rifle_info']); ?>
        </p>
        <br>
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="learn-list">
              <?php
                $paragraph = $rifle_course['rifle_learn'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
          ...
          <div class="col-lg-6">
            ...
            <ul class="equipment-list">
              <?php
                $paragraph = $rifle_course['rifle_equipment'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
        ...
        <?php
          $counter = $rifle_course['rifle_id'];
          $counter += 1;
         ?>
        <br id="rifle<?php echo $counter; ?>">
          ...
          <div class="carousel-inner row w-100 mx-auto">
            <div class="carousel-item active">
              <div class="d-none d-lg-block">
                <div class="slide-box">
                  <img src="images/teacher.jpg" alt="slide1">
                  <img src="images/rifle-pose.jpg" alt="slide1">
                  <img src="images/rifle1.jpg" alt="slide1">
                  <img src="images/rifle-storm.jpg" alt="slide1">
                </div>
              </div>
              ...
              <div class="d-block d-sm-none">
                <img class="d-block w-100" src="images/teaching-boss.jpg" alt="slide1">
              </div>
            </div>
            <div class="carousel-item">
              <div class="d-none d-lg-block">
                <div class="slide-box">
                  <img src="images/rifle2.jpg" alt="slide1">
              ...
              <div class="d-block d-sm-none">
                <img class="d-block w-100" src="images/range-boss.jpg" alt="slide2">
              </div>
            </div>
          </div>
    ...
    <div class="container-fluid progression" id="rifle-chart">
      <img src="images/rifle-progression.jpg" alt="rifle progression">
    </div>

    <a id="myBtn" href="#"><i class="fas fa-chevron-circle-up fa-2x"></i></a>

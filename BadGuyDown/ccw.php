...
<html>
  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown mx-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                ...
                <a class="dropdown-item active" href="ccw.php">Missouri CCW</a>
    ...
    <div class="container-fluid course-banner">
      <h1>Conceiled Carry Training</h1>
      <div class="header-line"></div>
    </div>

    <?php
      $result = $pdo->query("SELECT * FROM ccw_courses WHERE ccw_id = '1'");

      $row_array = $result->fetch(PDO::FETCH_ASSOC);
      $ccw_title = $row_array['ccw_title'];
      $ccw_prerequisites = $row_array['ccw_prerequisites'];
    ...
    <div class="container-fluid course-article">
      <div class="container course-info">
        <h2><?php echo $ccw_title; ?></h2>
        <div class="header-line-left"></div>
        <br>
        <p>
          <?php echo nl2br($ccw_info); ?>
        </p>
        <br>
        <a class="btn btn-secondary checklist" href="attachments/What to expect.pdf" download><i class="fas fa-file-download"></i> Download Checklist</a>
        ...
        <a class="btn btn-dark book-now" id="ccw-book-now" href="https://www.vagaro.com/badguydowntraining/classes?ig_fbb=true" target="_blank"><i class="fas fa-bookmark"></i> Book Now</a>
        <br><br>
      </div>

      <?php
      $counter = 0;
      foreach($ccw_courses as $ccw_course){
        if($counter == 0){
          $counter++;
          continue;
        } ?>
      <div class="container course-info">
        <h2><?php echo $ccw_course['ccw_title'] ?></h2>
        <div class="header-line-left"></div>
        <br>
        <h4>Prerequisites:</h4>
        <ul class="learn-list">
          <?php
            $paragraph = $ccw_course['ccw_prerequisites'];
            $lines = str_replace(".","<li>", $paragraph);
            echo $lines;
           ?>
        </ul>
        <p>
          <?php echo nl2br($ccw_course['ccw_info']); ?>
        </p>
        <br>
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="learn-list">
              <?php
                $paragraph = $ccw_course['ccw_learn'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
          ...
          <div class="col-lg-6">
            ...
            <ul class="equipment-list">
              <?php
                $paragraph = $ccw_course['ccw_equipment'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel" data-interval="9000">
          ...
          <div class="carousel-inner row w-100 mx-auto">
            ...
            <div class="carousel-item">
              ...
              <div class="d-block d-sm-none">
                <img class="d-block w-100" src="images/pistol-boss-fix.jpg" alt="slide2">
              </div>
            </div>
          </div>

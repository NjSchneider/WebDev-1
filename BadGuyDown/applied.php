...
<html>
  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                ...
                <a class="dropdown-item active" href="applied.php">Applied Courses</a>
    ...
    <div class="container-fluid course-banner">
      <h1>Applied Training</h1>
      <div class="header-line"></div>
    </div>

      <div class="container-fluid course-article">
        <div class="container course-info">
          <h2>Applied Courses: Putting in the Work</h2>
          <div class="header-line-left"></div>
          <br>
          <h4 style="text-decoration: underline;">Prerequisites</h4>
          <p>
            <div class="indent">
              Completion of any of the corresponding Skill-Based Courses. There are no “levels” to Applied Courses; you will be worked at your skill level.
            </div>
          </p>
          <p>
            Course Lengths: 4 hours
          </p>
          <p>
            Price: $59
          </p>
          ...
          <ul class="learn-list">
            <?php foreach($applied_courses as $applied_course){ ?>
              <li><?php echo $applied_course['applied_title']; ?></li>
              <?php } ?>
          </ul>
          <p>
            Applied Courses are for tuning and practicing. Attendees should know the base material before attending.
          </p>
          <br>
          ...
          <ul class="equipment-list">
            <li>Same as the Skill-based Course previously completed.</li>
            <li>Ammo requirement is up to the attendee.  300 to 1000 rounds recommended.</li>
          </ul>
          <br>

  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($learn)){
        ...
        $query = $pdo->prepare('INSERT INTO pistol_courses(pistol_title, pistol_tag, pistol_prerequisites, pistol_info, pistol_learn, pistol_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)');
...
<head>
  ...
  <title>Admin | Add Pistol Course</title>
  ...
  <body>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add Pistol Course</h2>
        ...
        <br>
        <a class="btn btn-secondary" href="pistol.php">&larr; Back</a>
      </div>
    </section>

  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
            <h1><span><img src="../../images/admin-header.png" height="100px"></span> Admin Access <small> Pistol</small></h1>
          </div>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Pistol</li>
        </ol>
      </div>
    </section>
    ...
    <section id="main">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card">
              <h3 class="card-header main-color-bg table-header">Current Pistol Courses<span class="float-right"><a class="btn btn-secondary add" href="add.php"><strong><span class="float-left"><i class="fas fa-plus"></i></span> Add Course</strong></a></span></h3>
              <div class="card-body">
                <table class="table table-striped table-dark table-hover mt-4">
                  ...
                  <tbody>
                    <?php foreach($pistol_courses as $pistol_course){ ?>
                      <tr>
                        <th scope="col"> <?php echo $pistol_course['pistol_title'] ?> </th>
                        <td><a class="btn btn-secondary edit" href="edit.php?id=<?php echo $pistol_course['pistol_id']; ?>"><span class="float-left"><i class="fas fa-pen"></i></span> Edit</a></td>
                        <td><a class="btn btn-danger delete" href="delete.php?id=<?php echo $pistol_course['pistol_id']; ?>"><span class="float-left"><i class="fas fa-eraser"></i></span> Delete</a></td>
                        <td><?php echo date('m/d/Y', $pistol_course['update_timestamp']) ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>

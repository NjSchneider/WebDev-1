  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($learn)){
        ...
        $query = $pdo->prepare('INSERT INTO applied_courses(applied_title, applied_tag, applied_prerequisites, applied_info, applied_learn, applied_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)');
...
<head>
  ...
  <title>Admin | Add Applied Course</title>
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="applied.php">Applied Courses</a></li>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add Applied Course</h2>

<?php
  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_GET['id'])){
      ...
      $result = $pdo->query("SELECT * FROM rifle_courses WHERE rifle_id = '$id'");

      $row_array = $result->fetch(PDO::FETCH_ASSOC);
      $rifle_title = $row_array['rifle_title'];
      $rifle_tag = $row_array['rifle_tag'];
      $rifle_prerequisites = $row_array['rifle_prerequisites'];
      $rifle_info = $row_array['rifle_info'];
      $rifle_learn = $row_array['rifle_learn'];
      $rifle_equipment = $row_array['rifle_equipment'];
    }
...
<head>
  ...
  <title>Admin | Edit Rifle Course</title>
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="rifle.php">Applied Courses</a></li>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <span class="float-left"><a class="btn btn-secondary" href="rifle.php">&larr; Cancel</a></span>
        <h2 style="text-align: center;">Edit <?php echo $applied_tag; ?></h2>
        ...
        <form class="add-course" action="update.php" method="post" autocomplete="off">
          ...
          <textarea name="title" rows="1" cols="57"><?php echo $applied_title; ?></textarea>
          <br>
          <br>
          <label for="tag"><h5><strong>Course Tag</strong></h5></label>
          <input type="text" name="tag" value="<?php echo $applied_tag; ?>">
          <br>
          <br>
          <label for="prerequisites"><h5><strong>Prerequisites</strong></h5></label>
          <textarea name="prerequisites" rows="4" cols="60"><?php echo $applied_prerequisites; ?></textarea>
          <br>
          <br>
          <label for="title"><h5><strong>Course Info</strong></h5></label>
          <textarea name="info" rows="6" cols="70"><?php echo $applied_info; ?></textarea>
          <br>
          <br>
          <div class="row">
            <div class="col-md-6">
              <label for="learn"><h5><strong>What will be Learned</strong></h5></label>
              <textarea name="learn" rows="12" cols="70"><?php echo $applied_learn; ?></textarea>
            </div>
            <div class="col-md-6">
              <label for="equipment"><h5><strong>Equipment Required</strong></h5></label>
              <textarea name="equipment" rows="12" cols="70"><?php echo $applied_equipment; ?></textarea>
            </div>
          </div>
          <br>

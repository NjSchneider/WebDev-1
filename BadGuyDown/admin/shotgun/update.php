<?php
  include_once('../../includes/connection.php');
    ...
    $query = $pdo->prepare("UPDATE shotgun_courses SET shotgun_title = ?, shotgun_tag = ?, shotgun_prerequisites = ?, shotgun_info = ?, shotgun_learn = ?, shotgun_equipment = ?, update_timestamp = ?  WHERE shotgun_id = '$id'");

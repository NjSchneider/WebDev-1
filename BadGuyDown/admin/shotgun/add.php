<?php
  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($prerequisites)){
        $error = 'All field are required!';
      } else{
        $query = $pdo->prepare('INSERT INTO shotgun_courses(shotgun_title, shotgun_tag, shotgun_prerequisites, shotgun_info, shotgun_learn, shotgun_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)');
  ...
  <body>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add Shotgun Course</h2>
        ...
        <br>
        <a class="btn btn-secondary" href="shotgun.php">&larr; Back</a>
      </div>
    </section>

  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($tag) or empty($prerequisites)){
        ...
        $query = $pdo->prepare('INSERT INTO cww_courses(response_title, cww_tag, cww_prerequisites, cww_info, cww_learn, cww_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)');
...
<head>
  ...
  <title>Admin | Add CCW Course</title>
  ...
  <body>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add C.C.W. Course</h2>
        ...
        <br>
        <a class="btn btn-secondary" href="ccw.php">&larr; Back</a>
      </div>
    </section>

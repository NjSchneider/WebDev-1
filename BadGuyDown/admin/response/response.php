...
<head>
  ...
  <title>Admin | Tactical Response</title>
  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h1><span><img src="../../images/admin-header.png" height="100px"></span> Admin Access <small> Tactical Response</small></h1>
          </div>
        </div>
      </div>
    </header>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Tactical Response</li>
        </ol>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="add.php" class="list-group-item list-group-item-action"><span class="float-left"><i class="fas fa-file-signature"></i></span> Add Tactical Response Course <span class="badge-pill"></span></a>
          ...
          <div class="col-md-9">
            <div class="card">
              <h3 class="card-header main-color-bg table-header">Current Tactical Response Courses<span class="float-right"><a class="btn btn-secondary add" href="add.php"><strong><span class="float-left"><i class="fas fa-plus"></i></span> Add Course</strong></a></span></h3>
              <div class="card-body">
                <table class="table table-striped table-dark table-hover mt-4">
                  ...
                  <tbody>
                    <?php foreach($response_courses as $response_course){ ?>
                      <tr>
                        <th scope="col"> <?php echo $response_course['response_title'] ?> </th>
                        <td><a class="btn btn-secondary edit" href="edit.php?id=<?php echo $response_course['response_id']; ?>"><span class="float-left"><i class="fas fa-pen"></i></span> Edit</a></td>
                        <td><a class="btn btn-danger delete" href="delete.php?id=<?php echo $response_course['response_id']; ?>"><span class="float-left"><i class="fas fa-eraser"></i></span> Delete</a></td>
                        <td><?php echo date('m/d/Y', $response_course['update_timestamp']) ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>

<?php
  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($tag) or empty($prerequisites)){
        $error = 'All field are required!';
      } else{
        $query = $pdo->prepare('INSERT INTO response_courses(response_title, response_tag, response_prerequisites, response_info, response_learn, response_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)');
...
<head>
  ...
  <title>Admin | Add Tactical Response</title>
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="response.php">Tactical Response</a></li>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add Tactical Response Course</h2>
        ...
        <form action="" method="post" autocomplete="off">
          ...
          <br>
          <br>
          <label for="title"><h5><strong>Course Tag</strong></h5></label>
        ...
        <br>
        <a class="btn btn-secondary" href="response.php">&larr; Back</a>
      </div>
    </section>

  ...
  <body>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        ...
        <h2 style="text-align: center;">Edit <?php echo $rifle_tag; ?></h2>
        ...
        <form class="add-course" action="update.php" method="post" autocomplete="off">
          ...
          <textarea name="title" rows="1" cols="57"><?php echo $rifle_title; ?></textarea>
          <br>
          <br>
          <label for="tag"><h5><strong>Course Tag</strong></h5></label>
          <input type="text" name="tag" value="<?php echo $rifle_tag; ?>">
          <br>
          <br>
          <label for="prerequisites"><h5><strong>Prerequisites</strong></h5></label>
          <textarea name="prerequisites" rows="4" cols="60"><?php echo $rifle_prerequisites; ?></textarea>
          <br>
          <br>
          <label for="title"><h5><strong>Course Info</strong></h5></label>
          <textarea name="info" rows="6" cols="70"><?php echo $rifle_info; ?></textarea>
          <br>
          <br>
          <div class="row">
            <div class="col-md-6">
              <label for="learn"><h5><strong>What will be Learned</strong></h5></label>
              <textarea name="learn" rows="12" cols="70"><?php echo $rifle_learn; ?></textarea>
            </div>
            <div class="col-md-6">
              <label for="equipment"><h5><strong>Equipment Required</strong></h5></label>
              <textarea name="equipment" rows="12" cols="70"><?php echo $rifle_equipment; ?></textarea>
            </div>
          </div>
          <br>

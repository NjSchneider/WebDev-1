<?php
  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_GET['id'])){
      ...
      $result = $pdo->query("SELECT * FROM boss_courses WHERE boss_id = '$id'");

      $row_array = $result->fetch(PDO::FETCH_ASSOC);
      $boss_title = $row_array['boss_title'];
      $boss_tag = $row_array['boss_tag'];
      $boss_info = $row_array['boss_info'];
      $boss_learn = $row_array['boss_learn'];
      $boss_equipment = $row_array['boss_equipment'];
    }
...
<head>
  ...
  <title>Admin | Edit B.o.S.S. Course</title>
  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h1><span><img src="../../images/admin-header.png" height="100px"></span> Admin Access <small> B.o.S.S. Courses</small></h1>
          </div>
        </div>
      </div>
    </header>
    ...
    <section id="breadcrumb">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="boss.php">B.o.S.S.</a></li>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <span class="float-left"><a class="btn btn-secondary" href="boss.php">&larr; Cancel</a></span>
        <h2 style="text-align: center;">Edit B.o.S.S. Course</h2>
        ...
        <form class="add-course" action="update.php" method="post" autocomplete="off">
          ...
          <textarea name="title" rows="1" cols="57"><?php echo $boss_title; ?></textarea>
          <br>
          <br>
          <label for="title"><h5><strong>Course Info</strong></h5></label>
          <textarea name="info" rows="6" cols="70"><?php echo $boss_info; ?></textarea>
          <br>
          <br>
          <div class="row">
            <div class="col-md-6">
              <label for="learn"><h5><strong>What will be Learned</strong></h5></label>
              <textarea name="learn" rows="12" cols="70"><?php echo $boss_learn; ?></textarea>
            </div>
            <div class="col-md-6">
              <label for="equipment"><h5><strong>Equipment Required</strong></h5></label>
              <textarea name="equipment" rows="12" cols="70"><?php echo $boss_equipment; ?></textarea>
            </div>
          </div>
          <br>
          <br>

  ...
  if(isset($_SESSION['logged_in'])){
    if(isset($_POST['submit'])){
      ...
      if(empty($title) or empty($learn)){
        ...
        $query = $pdo->prepare('INSERT INTO boss_courses(boss_title, boss_prerequisites, boss_info, boss_learn, boss_equipment, update_timestamp) VALUES(?, ?, ?, ?, ?, ?)');

        $query->bindValue(1, $title);
        $query->bindValue(2, $prerequisites);
        $query->bindValue(3, $info);
        $query->bindValue(4, $learn);
        $query->bindValue(5, $equipment);
...
<head>
  ...
  <title>Admin | Edit B.o.S.S.</title>
  ...
  <body>
    ...
    <section class="main">
      <div class="container-fluid add-course">
        <h2 style="text-align: center;">Add B.o.S.S. Course</h2>
        ...
        <form class="add-course" action="" method="post" autocomplete="off">
        ...
        <br>
        <a class="btn btn-secondary" href="boss.php">&larr; Back</a>
      </div>
    </section>

...
<html lang="en" dir="ltr">
  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown mx-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                <a class="dropdown-item active" href="boss.php">B.o.S.S.</a>
    ...
    <div class="container-fluid course-banner">
      <h1>Basics of Safe Shooting (B.o.S.S.)</h1>
    ...
    <div class="container-fluid course-article">
      ...
      <div class="container course-info">
        <p>
          <?php echo nl2br($boss_course['boss_info']); ?>
        </p>
        <br>
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="learn-list">
              <?php
                $paragraph = $boss_course['boss_learn'];
          ...
          <div class="col-lg-6">
            ...
            <ul class="equipment-list">
              <?php
                $paragraph = $boss_course['boss_equipment'];
                $lines = str_replace(".", "<li>", $paragraph);
                echo $lines;
              ?>
            </ul>

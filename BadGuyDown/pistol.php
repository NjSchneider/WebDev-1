<?php
  ...
  $pistol_course = new Pistol_Course;
  $pistol_courses = $pistol_course->fetch_all();
...
<html>
  ...
  <body id="homepage" data-spy="scroll" data-target=".navBar" data-offset="60">
          ...
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarNavDropdownLink">
                ...
                <a class="dropdown-item active" href="pistol.php">Pistol</a>
    ...
    <div class="container-fluid course-banner">
      <h1>Pistol Training</h1>
      <div class="header-line"></div>
      <br id="pistol1">
      <nav class="navbar navbar-expand-lg course-intraNav" id="pistol-nav">
        <button class="navbar-toggler  course-nav-btn" type="button" data-toggle="collapse" data-target="#courseNav" aria-controls="courseNav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"><i class="fas fa-caret-down"></i></span> <strong>Pistol Courses</strong>
        </button>
        <div class="collapse navbar-collapse" id="courseNav">
          <ul class="navbar-nav ml-auto mr-4">
            <?php foreach($pistol_courses as $pistol_course){ ?>
            <li>
              <strong><a href="#pistol<?php echo $pistol_course['pistol_id']; ?>"><?php echo $pistol_course['pistol_tag']; ?></a></strong>
            </li>
          <?php } ?>
          </ul>
        </div>
      </nav>
      <a class="btn btn-secondary chart-button" href="#pistol-chart"><span class="float-left double-down"><i class="fas fa-angle-double-down"></i></span>Pistol Course Progression</a>
    </div>

    <div class="container-fluid course-article">
      <?php foreach($pistol_courses as $pistol_course) { ?>
      <div class="container course-info">
        <h2><?php echo $pistol_course['pistol_title'] ?></h2>
        <div class="header-line-left"></div>
        <br>
        <h4>Prerequisites:</h4>
        <ul class="learn-list">
          <?php
            $paragraph = $pistol_course['pistol_prerequisites'];
            $lines = str_replace(".","<li>", $paragraph);
            echo $lines;
           ?>
        </ul>
        <p>
          <?php echo nl2br($pistol_course['pistol_info']); ?>
        </p>
        <br>
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="learn-list">
              <?php
                $paragraph = $pistol_course['pistol_learn'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
          ...
          <div class="col-lg-6">
            ...
            <ul class="equipment-list">
              <?php
                $paragraph = $pistol_course['pistol_equipment'];
                $lines = str_replace(".","<li>", $paragraph);
                echo $lines;
               ?>
            </ul>
        ...
        <?php
          $counter = $pistol_course['pistol_id'];
          $counter += 1;
         ?>
            ...
            <div class="carousel-item active">
              <div class="d-none d-lg-block">
                <div class="slide-box">
                  ...
                  <img src="images/pistol-aim.jpg" alt="slide1">
                </div>
              </div>
              ...
              <div class="d-none d-sm-block d-md-none">
                <div class="slide-box">
                  <img src="images/pistol-boss-fix.jpg" alt="slide1">
                  <img src="images/teacher-pistol.jpg" alt="slide2">
                </div>
              </div>
              <div class="d-block d-sm-none">
                <img class="d-block w-100" src="images/pistol-boss-fix.jpg" alt="slide1">
              </div>
            </div>
            <div class="carousel-item">
              <div class="d-none d-lg-block">
                <div class="slide-box">
                  ...
                  <img src="images/pistol-target.jpg" alt="slide2">
                </div>
              </div>
              <div class="d-none d-md-block d-lg-none">
                <div class="slide-box">
    ...
    <div class="container-fluid progression" id="pistol-chart">
      <img src="images/pistol-progression.jpg" alt="pistol progression">
    </div>
    ...
    <script>
      ...
      $(window).scroll(function() {
        ...
        if(document.body.scrollTop > 4180 || document.documentElement.scrollTop > 4180){
          document.getElementById("myBtn").style.display = "none";
        }
      });

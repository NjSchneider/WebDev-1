...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container-fluid page">
      ...
      <div class="container-fluid">
        <div class="about-intro">
          <div class="row">
            <div class="col-sm-5" id="family-image">
                <img  id="about-image" src="images/about-fix1.jpg" alt="Our Family">
            </div>
            <div class="col-sm-7" id="about-family">
                <h2>Our Family</h2>
                <div class="header-line"></div>
                <br>
                <p>
      ...
      <div class="container-fluid">
        <div class="container" id="about-process">
          <h1>What do we Produce?</h1>
          <div class="header-line"></div>
          <p>
            Vegetables and herbs, such as tomatoes, a large variety of peppers including Paprika Alma (for Hungarian Goulash), pepitos, and large hot jalapenos for stuffing.
            Potatoes, sweet potatoes, corn, beets, onions, carrots, cabbage, Brussel sprouts, broccoli, cauliflower, watermelon, cantaloupe, butternut squash, spaghetti squash,
            zucchini and pumpkin. Besides eggs, we raise chickens and turkeys for meat.
          </p>
        </div>
        <br><br>
        <div id="about-gallery">
          <div class="row">
            ...
            <div class="col-sm-3">
              <img src="images/chickens.jpg" alt="">
            </div>
          </div>
          <div class="row" id="row2">
            <div class="col-sm-3">
              <img src="images/chicks.jpg" alt="">
            </div>
            <div class="col-sm-3">
              <img src="images/peppers.jpg" alt="">
            </div>
            <div class="col-sm-3">
              <img src="images/canned.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid" id="footer-image">
      <img src="images/harvest.jpg" alt="stuff" width="1000px" height="500px" id="about-footer-image">
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Harvest Gallery</h5>

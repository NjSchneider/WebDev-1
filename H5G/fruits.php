...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto mr-4">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarNavDropdownMenuLink" data-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                Products
              </a>
    ...
    <div class="container-fluid" id="vegetables-cards">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 product-start">
          <a href="#<?php echo $fruit['fruit_title']; ?>">
          <img class="product cardImg" id="fruit-product" src=" <?php echo $fruit['fruit_image']; ?> " alt=" <?php echo $fruit['fruit_title']; ?> ">
          <div class="card">
            <div class="card-body">
              <h5> <?php echo $fruit['fruit_title']; ?> </h5>
              <p> <?php echo $fruit['fruit_tag']; ?> </p>
            </div>
          </div>
          </a>
        </div>
    ...
    <div class="container-fluid" id="fruit-process-info">
      <h2>Our Fruit Process</h2>
      <div id="process">
        <p>
    ...
    <?php
      $result = $pdo->query("SELECT * FROM fruits WHERE fruit_id = '1'");

      $row_array = $result->fetch(PDO::FETCH_ASSOC);
      $fruit_title = $row_array['fruit_title'];
      $fruit_image = $row_array['fruit_image'];
      $fruit_content = $row_array['fruit_content'];
     ?>
  <div class="banner" id="<?php echo $fruit_title ?>">
    <br>
    <h3>Why Our Fruit?</h3>
    <div class="header-line"></div>
    <br>
    ...
    <div class="container-fluid" id="vegetables-products">
      <div class="row">
        <div class="col-sm-4">
          <img class="float-right prod-detImg" src=" <?php echo $fruit_image ?> " alt="<?php echo $fruit_image ?>">
        </div>
        <div class="col odd">
          <h4 class="odd"> <?php echo $fruit_title ?> </h4>
          <p> <?php echo $fruit_content ?> </p>
        </div>
        <div class="col-sm-2">
          <!-- padding col -->
        </div>
      ...
      <?php
        $result = $pdo->query("SELECT * FROM fruits WHERE fruit_id = '2'");
      ...
      <div class="divider-products" id="<?php echo $fruit_title ?>"></div>
      <br><br>
      ...
      <div class="row">
        ...
        <div class="col even">
          <h4 class="even"> <?php echo $fruit_title ?> </h4>
          <p> <?php echo $fruit_content ?> </p>
        </div>
        <div class="col-sm-4">
          <img class="float-left prod-detImg" src=" <?php echo $fruit_image ?> " alt="<?php echo $fruit_image ?>">
        </div>
      </div>

      <?php
        $result = $pdo->query("SELECT * FROM fruits WHERE fruit_id = '3'");

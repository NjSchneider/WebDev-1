  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item active" href="vegetables.php">Vegetables</a>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
            <h1><span><i class="fas fa-cog"></i></span>Vegetables<small> Manage Vegetables Product Page</small></h1>
          </div>
    ...
    <section id="main">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="#" class="list-group-item list-group-item-action active main-color-bg">
                <span><i class="fas fa-cog"></i></span> Vegetables
              </a>
          ...
          <div class="col-md-9">
            <div class="card">
              <h3 class="card-header main-color-bg">Vegetable Page Log</h3>
              <div class="card-body">
                <table class="table table-striped table-dark table-hover mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"> <?php echo $vegetable['vegetable_title'] ?> </th>
                      <td><span><i class="fas fa-check"></i></span></td>
                      <td><?php echo date('m/d/Y', $vegetable['update_timestamp']) ?></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
    ...
    <section id="home-edit">
      ...
      <div class="container-fluid">
        <div class="row" style="width: 80%; margin: auto;">
          <?php foreach($vegetables as $vegetable){ ?>
          <div class="col-sm-4">
            <h4>Product <?php echo $vegetable['vegetable_id']; ?></h4>
            <form action="update.php" method="post">
              <input type="hidden" name="id" value="<?php echo $vegetable['vegetable_id']; ?>">
              <input type="text" name="title" value="<?php echo $vegetable['vegetable_title']; ?>">
              <br><br>
              <input type="text" name="image" value="<?php echo $vegetable['vegetable_image']; ?>">
              <br><br>
              <textarea name="tag" rows="3" cols="40"><?php echo $vegetable['vegetable_tag']; ?></textarea>
              <br><br>
              <textarea name="content" rows="10" cols="55"><?php echo $vegetable['vegetable_content']; ?></textarea>
              <br>

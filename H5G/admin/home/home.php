...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Home Page</title>
  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
            <h1><span><i class="fas fa-cog"></i></span>Home<small> Manage Home Page</small></h1>
          </div>
    ...
    <section id="main">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="index.html" class="list-group-item list-group-item-action active main-color-bg">
                <span><i class="fas fa-cog"></i></span> Home Page
              </a>
          ...
          <div class="col-md-9">
            <div class="card">
              <h3 class="card-header main-color-bg">Home Page Log</h3>
              <div class="card-body">
                <div class="row">
                </div>
    ...
    <div class="container-fluid" style="text-align: center">
      <br>
      <h1>Current Spotlighted Products</h1>
    ...
    <section id="home-edit">
      ...
      <div class="container-fluid">
        <div class="row" style="width: 80%; margin: auto;">
          ...
          <div class="col-sm-4">
            <h4>Product <?php echo $product['product_id']; ?></h4>
            <form action="update.php" method="post">
              <input type="hidden" name="id" value="<?php echo $product['product_id']; ?>">
              <input type="text" name="title" value="<?php echo $product['product_title']; ?>">
              <br><br>
              <input type="text" name="image" value="<?php echo $product['product_image']; ?>">
              <br><br>
              <textarea name="content" rows="8" cols="40"><?php echo $product['product_content']; ?></textarea>
              <br>
